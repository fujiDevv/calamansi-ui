            ...
            trailing={
              <div className="flex items-center gap-1.5">
                <div className="flex items-end gap-0.5 h-3">
                  ...
                  <span className="w-0.5 h-2/3 bg-emerald-400 animate-pulse rounded-full delay-75" />
                  <span className="w-0.5 h-4/5 bg-emerald-400 animate-pulse rounded-full delay-150" />
                </div>
              </div>
            }
            expandedContent={
              <div className="flex size-full flex-col justify-between">
                <div className="flex items-center gap-3">
                  <div className="size-11 shrink-0 rounded-xl bg-gradient-to-br from-emerald-500 to-lime-600 flex items-center justify-center text-white shadow-md">
              ...
              <div className="flex size-full flex-col items-center justify-between py-1 text-center">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="button"
                    onClick={(e) => e.stopPropagation()}
                    className="rounded-full bg-amber-500 px-4 py-1 text-xs font-semibold text-amber-950 transition hover:bg-amber-400"
                  >
                    Pause
                  </button>
                </div>
          ...
          <DynamicIsland
            ...
            expandedContent={
              <div className="flex size-full flex-col justify-between py-1">
                ...
                <div className="grid grid-cols-2 gap-2 rounded-xl bg-white/10 p-2 text-center text-xs">
                  <div>
                    <p className="text-[10px] text-white/50">Left Earbud</p>
                    <p className="font-semibold text-white">98%</p>
                  </div>
                  <div>
                    <p className="text-[10px] text-white/50">Right Earbud</p>
