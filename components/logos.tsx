...
export function LinkedinLogo({ className }: LogoProps) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M27.26 0H4.74A4.74 4.74 0 0 0 0 4.74v22.52A4.74 4.74 0 0 0 4.74 32h22.52A4.74 4.74 0 0 0 32 27.26V4.74A4.74 4.74 0 0 0 27.26 0M9.61 27.26H4.87V11.94h4.74ZM7.24 9.9a2.75 2.75 0 1 1 0-5.5 2.75 2.75 0 0 1 0 5.5m20.02 17.36h-4.73v-7.45c0-1.77-.03-4.05-2.47-4.05-2.47 0-2.85 1.93-2.85 3.92v7.58h-4.73V11.94h4.54v2.09h.07a4.98 4.98 0 0 1 4.48-2.46c4.79 0 5.68 3.15 5.68 7.25Z"
      />
    </svg>
  );
}
